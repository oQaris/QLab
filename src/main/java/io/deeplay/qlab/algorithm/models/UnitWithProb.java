...
public class UnitWithProb {
    ...
    public UnitWithProb(String name, Double sourceGoldCount, Double shield, Double evasiveness, Double aggression, Double responseAggression, int locationPosition) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return locationPosition == that.locationPosition && Objects.equals(name, that.name) && Objects.equals(sourceGoldCount, that.sourceGoldCount) && Objects.equals(shield, that.shield) && Objects.equals(evasiveness, that.evasiveness) && Objects.equals(aggression, that.aggression) && Objects.equals(responseAggression, that.responseAggression);
    }
