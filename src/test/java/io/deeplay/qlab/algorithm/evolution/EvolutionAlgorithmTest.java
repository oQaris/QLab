...
class EvolutionAlgorithmTest {
    ...
    void findDisposition_ManyLocationTest() {
        ...
        Set<UnitWithLocation> actual = new EvolutionAlgorithm(20, 2, 1,
                new SumSourceProfitEvaluator(), locations.stream().toList()).start(units.stream().toList());
    ...
    void findDisposition_EmptyTest() {
        ...
        assertEquals(expected, new EvolutionAlgorithm(20, 2, 1,
                new SumSourceProfitEvaluator(), locations.stream().toList()).start(units.stream().toList()));
    }
